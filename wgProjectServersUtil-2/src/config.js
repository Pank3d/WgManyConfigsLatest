...
module.exports.WG_DEFAULT_ADDRESS =
  process.env.WG_DEFAULT_ADDRESS || "10.8.x.y";
module.exports.WG_DEFAULT_DNS =
...
module.exports.WG_POST_UP =
  ...
  `
iptables -t nat -A POSTROUTING -s 10.8.0.0/16 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
module.exports.WG_POST_DOWN =
  ...
  `
iptables -t nat -D POSTROUTING -s 10.8.0.0/16 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
